...
namespace SiemensProjectManagement.Controllers
{
    public class DevicesController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "Id,Mlfb,BuildTargetName,ProductName,TypeName")] Device device)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "Id,Mlfb,BuildTargetName,ProductName,TypeName")] Device device)
        {
            if (ModelState.IsValid)
            {
